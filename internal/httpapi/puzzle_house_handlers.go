...
func (s *Server) handlePuzzleHouses(w http.ResponseWriter, r *http.Request, sess *adminauth.Session) {
	...
	result, err := analytics.GetPuzzleHouses(r.Context(), s.ReaderPool, projectID, from, to, scope, puzzleBuild(r))
	if err != nil {
		s.fail(w, r, requestID, start, err)
		return
	}
...
func (s *Server) handlePuzzleHouseDetail(w http.ResponseWriter, r *http.Request, sess *adminauth.Session) {
	...
	result, err := analytics.GetPuzzleHouse(r.Context(), s.ReaderPool, projectID, cityID, houseID, from, to, scope, puzzleBuild(r))
	if err != nil {
		s.fail(w, r, requestID, start, err)
		return
	}
...
func (s *Server) handlePuzzleWaveFunnel(w http.ResponseWriter, r *http.Request, sess *adminauth.Session) {
	...
	result, err := analytics.GetPuzzleWaveFunnel(r.Context(), s.ReaderPool, projectID, cityID, houseID, from, to, scope, puzzleBuild(r))
	if err != nil {
		s.fail(w, r, requestID, start, err)
		return
	}
...
func (s *Server) handlePuzzleDrops(w http.ResponseWriter, r *http.Request, sess *adminauth.Session) {
	...
	result, err := analytics.GetPuzzleDrops(r.Context(), s.ReaderPool, projectID, cityID, houseID, blockID, from, to, scope, puzzleBuild(r))
	if err != nil {
		s.fail(w, r, requestID, start, err)
		return
	}
