...
// Puzzle Gravity gameplay diagnostics live in gameplayTypes.ts, split out
// to keep this file under the repo's line-count gate.
export type {
  GameplaySummary,
  GameplayScope,
  GameplayFriction,
  GameplayDiagnostics,
  GameplayDaily,
  GameplayAttemptEvent,
  GameplayAttempt,
  GameplayPlayer,
  GameplayPlayersResult,
} from './gameplayTypes'
